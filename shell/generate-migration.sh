...
export TYPEORM_PASSWORD="${TYPEORM_PASSWORD:-secret}"
...
export TYPEORM_ENTITIES="${TYPEORM_ENTITIES:-src/db/entities/*.ts}"
export TYPEORM_MIGRATIONS="${TYPEORM_MIGRATIONS:-src/db/migrations/*.ts}"
