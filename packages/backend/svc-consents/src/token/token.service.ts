...
export class TokenService {
  ...
  private readonly tokenExpiration: SvcConsents.ExpirationTime;
  ...
  constructor(
    ...
    this.tokenExpiration = configService.get<SvcConsents.ExpirationTime>('JWT_TOKEN_EXPIRATION')!;
  }
   ...
   */
  generate(payload: SvcConsents.JwtPayload): Promise<string> {
